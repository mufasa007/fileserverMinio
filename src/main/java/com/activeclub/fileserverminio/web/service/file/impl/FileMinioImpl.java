...
//            format = circleSp[1];
//            minioPath = fileOperationDto.getPath() + "/" + fileNameOnly + "(" + DateUtil.getPreTime() + ")." + format;
//        } else {
//            minioPath = fileOperationDto.getPath() + "/" + fileNameOnly + "(" + DateUtil.getPreTime() + ")";
//        }
//
//        // 调用minio上传文件
//        try {
...
//        file.setUrl(previewUrl);
//
//        file.setBucket(fileOperationDto.getBucket());
//        file.setPath(minioPath);
//
//        file.setMd5(md5Code);
//        file.setSize(multipartFile.getSize());
//        file.setCreatorAccountName(sessionService.getPreAccountName(fileOperationDto.getAccountName()));
//        // 数据库操作(异步) todo
